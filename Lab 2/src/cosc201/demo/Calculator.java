...
/**
 * Simple demonstration of a 'script reading' program (see the video in the 
 * Demonstrations section of the Echo stream for more information)
 */
public class Calculator {
  ...
  public static void main(String[] args) {
    ...
    // Get the initial line containing the size of the array
